#pragma checksum "C:\Users\gherr\Documents\Proyectos\plataformaOriginacion\plataformaOriginacion\Views\Bandeja\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6353679fbc131851e8d6bbb2a97e201d805e4a2b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6353679fbc131851e8d6bbb2a97e201d805e4a2b", @"/Views/Bandeja/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6353679fbc131851e8d6bbb2a97e201d805e4a2b4719", async() => {
            }
            );
...
<script>
    ...
    function dataGrid_change_cellTemplate2(element, info) {
        ...
        //var clase = data.status == 2 ? 'success' : data.status == 3 ? ");
            WriteLiteral(@"'danger' : data.status == 6 || data.status == 6 ? 'warning' : 'primary';
    ...
    function dataGrid_change_cellTemplate3(element, info) {
        ...
        var fecha = new Date(data.fechaCaputra).toLocaleDateString(""es-MX"", ");
    ...
    function dataGrid_change_cellTemplate5(element, info) {
        ...
        //var label = data.tipoContrato == 1 ? ""INDIVIDUAL"" : d");
            WriteLiteral(@"ata.tipoContrato == 2 ? ""GRUPAL"" : ""Sin Especificar"";
    ...
    function dataGrid_change_cellTemplate6(element, info) {
        ...
        var label2 = data.tipoContrato == 1 ? ""<span class='flaticon-man-user' style='position: relative; margin-left: -20px");
            WriteLiteral(@";color: black;'><i> "" + label + ""</i></span>"" : data.tipoContrato == 2 ? ""<span class='flaticon-users-group' style='position: relative; margin-left: -20px;color: black;'><i> "" + label +""</i></span>"" : ""<span class='flaticon-pause-symbol' style='position: relative; margin-left: -20px;color: green;'><i> Sin especificar</i></span>"";
...
<script>
    $(document).ready(function () {
        ...
        var rotate = function () {
            ...
            mi");
            WriteLiteral(@"nutes = minutes < 10 ? ""0"" + minutes : minutes;
...
<script>
    ...
    */
    ...
    ! function (root, factory) {
        ...
        loca");
            WriteLiteral(@"lization.loadMessages({
            en: {
                Yes: ""S\xed"",
                No: ""No"",
                Cancel: ""Cancelar"",
                ...
                ""validation-stringLength-formatted"": ""El tama\xf1o de");
            WriteLiteral(@" {0} es incorrecto"",
            ...
            ");
            WriteLiteral(@"    ""dxFileUploader-kb"": ""kb"",
                ...
                ""dxNumberBox-invalidValueMessage"": ""Valor debe se");
            WriteLiteral(@"r un n\xfamero"",
         ...
         ");
            WriteLiteral(@"       ""dxDataGrid-validationCancelChanges"": ""Cancelar cambios"",
       ...
       ");
            WriteLiteral(@"         ""dxDataGrid-filterRowOperationNotContains"": ""No contiene"",
                ...
                ""dxD");
            WriteLiteral(@"ataGrid-summaryMinOtherColumn"": ""M\xedn de {1} es {0}"",
                ...
                ""dxDataGrid-selectedRows"": ""Filas seleccionad");
            WriteLiteral(@"as"",
                ...
                ""dxDataGrid-filterPanelCreateFilter"": ""Crear filt");
            WriteLiteral(@"ro"",
                ...
                ""dxPivotGrid-removeAllSorting"": ""Remover ordenamien");
            WriteLiteral(@"to"",
                ...
                ""dxScheduler-editorLabelRecurren");
            WriteLiteral(@"ce"": ""Repetir"",
                ...
                ");
            WriteLiteral(@"""dxScheduler-switcherWeek"": ""Semana"",
                ...
                ""dxScheduler-confirmRe");
            WriteLiteral(@"currenceEditSeries"": ""Modificar serie"",
                ...
                ""vizExport-printingButt");
            WriteLiteral(@"onText"": ""Imprimir"",
      ...
      ");
            WriteLiteral(@"          ""dxFilterBuilder-filterOperationStartsWith"": ""Comienza con"",
    ...
    ");
            WriteLiteral(@"            ""dxHtmlEditor-dialogLinkTargetField"": ""Abrir enlace en nueva ventana"",
