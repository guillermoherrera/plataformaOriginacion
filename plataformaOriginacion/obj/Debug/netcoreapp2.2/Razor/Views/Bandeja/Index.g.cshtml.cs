#pragma checksum "C:\Users\gherr\Documents\Proyectos\plataformaOriginacion\plataformaOriginacion\Views\Bandeja\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "127a351ae75a308285ac01b408575be3005bf06f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"127a351ae75a308285ac01b408575be3005bf06f", @"/Views/Bandeja/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "127a351ae75a308285ac01b408575be3005bf06f4719", async() => {
            }
            );
...
<script>
    ...
    function dataGrid_change_cellTemplate6(element, info) {
        ...
        if (data.grupoID == null) {
            label = (data.renovacion ? ""<strong> (R)  </strong>"" : """") + data.persona.nombre + "" "" + data.persona.nombreSegundo + "" "" + data.persona.apellido");
            WriteLiteral(@" + "" "" + data.persona.apellidoSegundo
        } else {
            label = (data.renovacion ? ""<strong> (R)  </strong>"" : """") + data.grupoNombre
        }
        var label2 = data.tipoContrato == 1 ? ""<span class='flaticon-man-user' style='position: relative; margin-left: -20px;color: black;'><i> "" + label + ""</i></span>"" : data.tipoContrato == 2 ? ""<span class='flaticon-users-group' style='position: relative; margin-left: -20px;color: "" + (data.renovacion ? ""brown"" : ""black"") + "";'><i> "" + label +""</i></span>"" : ""<span class='flaticon-pause-symbol' style='position: relative; margin-left: -20px;color: green;'><i> Sin especificar</i></span>"";
...
<script>
    $(document).ready(function () {
        ...
        $(""#btn_restart"").click(function () {
            ...
            if (accion == 'DETENER') {
               ");
            WriteLiteral(@" clearInterval(intervalID);
    ...
    ! function (root, factory) {
        if (""function"" === typeof define && define.amd) {
            define(function (require) {
                factory(require(""devextreme/loc");
            WriteLiteral(@"alization""))
            })
        } else {
        ...
        localization.loadMessages({
            en: {
                ...
                ""validation-numeric-fo");
            WriteLiteral(@"rmatted"": ""{0} debe ser un n\xfamero"",
                ...
                ""dxLookup-searchPlaceholder"": ""Cantidad m\xednima de caractere");
            WriteLiteral(@"s: {0}"",
            ...
            WriteLiteral(@": ""Seleccione fecha y hora"",
                ...
                ""dxRange");
            WriteLiteral(@"Slider-ariaTill"": ""Hasta"",
                ...
                ""dxDataGrid-editingSaveRowChanges"": ""Gu");
            WriteLiteral(@"ardar"",
                ...
                ""dxDataGrid-filterRowOperationLessOrEquals"": ""Me");
            WriteLiteral(@"nor o igual a"",
                ...
                ""dxDataGrid-sortingClea");
            WriteLiteral(@"rText"": ""Limpiar Ordenamiento"",
            ...
            WriteLiteral(@""",
                ...
                ""dxDataGrid-ari");
            WriteLiteral(@"aSearchInGrid"": ""Buscar en la tabla de datos"",
                ...
                ""dxPivotGrid-e");
            WriteLiteral(@"xpandAll"": ""Expandir Todo"",
            ...
            WriteLiteral(@"xed"",
                ...
                """);
            WriteLiteral(@"dxScheduler-recurrenceRepeatDaily"": ""d\xeda(s)"",
       ...
       ");
            WriteLiteral(@"         ""dxScheduler-allDay"": ""Todo el d\xeda"",
                ...
                ""dxCol");
            WriteLiteral(@"orView-ariaAlpha"": ""Transparencia"",
     ...
     ");
            WriteLiteral(@"           ""dxFilterBuilder-filterOperationLess"": ""Menos que"",
                ...
                ""dxHtmlEditor-dialogColorCap");
            WriteLiteral(@"tion"": ""Cambiar el color de la fuente"",
